...
//6.保存新的leaseTermList
    ...
    @Autowired
    RoomAttrValueMapper attrValueMapper;
    @Autowired
    RoomFacilityMapper facilityInfoMapper;
    @Autowired

    RoomLabelMapper labelInfoMapper;
    @Autowired
    RoomPaymentTypeMapper paymentTypeMapper;
    @Autowired
    RoomLeaseTermMapper leaseTermMapper;
    @Autowired
