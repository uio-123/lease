...
public class SystemUserServiceImpl extends ServiceImpl<SystemUserMapper, SystemUser>
    ...
    @Override
    public IPage<SystemUserItemVo> pageUserByQuery(IPage<SystemUserItemVo> page, SystemUserQueryVo queryVo) {
        return mapper.pageUserByQuery(page, queryVo);
    }

    @Override
    public SystemUserItemVo getUserById(Long id) {
        SystemUser user = this.getById(id);
        SystemPost post = postService.getById(user.getPostId());
