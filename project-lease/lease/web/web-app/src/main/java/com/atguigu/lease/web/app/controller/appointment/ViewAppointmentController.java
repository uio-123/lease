...
public class ViewAppointmentController {
    ...
    public Result saveOrUpdate(@RequestBody ViewAppointment viewAppointment) {
        viewAppointmentService.saveAppointment(viewAppointment);
        return Result.ok();
    }
    ...
    public Result<List<AppointmentItemVo>> listItem() {
        ...
        List<AppointmentItemVo> list = viewAppointmentService.listAppointmentsByUserId(userId);
    ...
    public Result<AppointmentDetailVo> getDetailById(@RequestParam Long id) {
        ...
        Long userId = loginUser.getUserId();
        AppointmentDetailVo detailVo = viewAppointmentService.getAppointmentDetailById(id, userId);
